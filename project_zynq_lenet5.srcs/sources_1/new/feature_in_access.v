...
module feature_in_access(
    ...
    output reg signed [`CONV_IN_BIT_WIDTH_F*5-1:0] feature_in_1,
    output reg signed [`CONV_IN_BIT_WIDTH_F*5-1:0] feature_in_2,
    output reg signed [`CONV_IN_BIT_WIDTH_F*5-1:0] feature_in_3*/
    ...
    wire[`CONV_IN_BIT_WIDTH_F*5-1:0] feature_bank_0_block_0, feature_bank_0_block_1;
/*    wire[`CONV_IN_BIT_WIDTH_F*5-1:0] feature_bank_1_block_0, feature_bank_1_block_1;
    wire[`CONV_IN_BIT_WIDTH_F*5-1:0] feature_bank_2_block_0, feature_bank_2_block_1;
    wire[`CONV_IN_BIT_WIDTH_F*5-1:0] feature_bank_3_block_0, feature_bank_3_block_1;*/


    
    //已验证从高到低 5 个 byte（8bit）确实是根据从高到低 5 位 wea 判断对应字节是否写入
    feature_mem_bank_0_block_0 feature_mem_bank_0_block_0(
        .clka(clk),
        .addra(feature_addr_b0),
        /*.dina(40'd0),
        .wea(5'b00000),*/
        .douta(feature_bank_0_block_0)
    );
    
    feature_mem_block_1 feature_mem_bank_0_block_1(
        .clka(clk),
        .addra(feature_addr_b1),
        /*.dina(40'd0),
        .wea(5'b00000),*/
        .douta(feature_bank_0_block_1)
    );

    // 需要设置一个缓冲的 buffer，随时为从上往下移的那一步准备着，在从上往下的那一步将其送出去
    reg[`CONV_IN_BIT_WIDTH_F*5-1:0] feature_in_buffer_0;
    /*reg[`CONV_IN_BIT_WIDTH_F*5-1:0] feature_in_buffer_1;
    reg[`CONV_IN_BIT_WIDTH_F*5-1:0] feature_in_buffer_2;
    reg[`CONV_IN_BIT_WIDTH_F*5-1:0] feature_in_buffer_3;*/
