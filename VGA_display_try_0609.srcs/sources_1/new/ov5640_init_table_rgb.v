...
(
    ...
    initial begin
        ...
        rom[1] = 24'h3008_82; // software reset, bit[7]                 // 不能硬件复位的情况下只能软件复位了
        // delay 5ms
        ...
        rom[55] = 24'h302e_00;
        rom[56] = 24'h4300_A1; // RGB444 format2    {4'b0,r[3:0]},{g[3:0],b[3:0]}
        rom[57] = 24'h501f_01; // ISP RGB
        rom[58] = 24'h440e_00;
        ...
        rom[219] = 24'h3804_0a; // HW (HE)
        rom[220] = 24'h3805_3f; // HW (HE)
        rom[221] = 24'h3806_06; // VH (VE)
        rom[222] = 24'h3807_a9; // VH (VE)
        rom[223] = {16'h3808, IMAGE_WIDTH[15:8]}; // DVPHO  (<1280>500) (<640>280) IMAGE_WIDTH
        rom[224] = {16'h3809, IMAGE_WIDTH[ 7:0]}; // DVPHO
        rom[225] = {16'h380a, IMAGE_HEIGHT[15:8]}; // DVPVO (<720>2d0) (<480>1e0) IMAGE_WIDTH
        rom[226] = {16'h380b, IMAGE_HEIGHT[ 7:0]}; // DVPVO
        rom[227] = 24'h380c_07; // HTS          （1892） 行像素点
        rom[228] = 24'h380d_64; // HTS          （740）
        ...
        //write_i2c(0x3a08, 0x00); // B50 step
        //write_i2c(0x3a09, 0x6f); // B50 step
        //write_i2c(0x3a0a, 0x00); // B60 step
        //write_i2c(0x3a0b, 0x5c); // B60 step
